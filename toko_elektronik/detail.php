    ...
    <div class="wrapper-detail-produk"> 
      ...
      <form action="" method="POST">
          <div class="detail-produk">   
              <h4 class="nama-produk">Produk  : <?= $data["nama_produk"]; ?></h4>
              <p class="harga-produk">Prize : Rp <?= $data["harga_produk"]; ?></p>

              <p class="deskripsi-produk">Deskripsi : <?= $data["deskripsi_produk"]; ?></p>
